...
export class AlertService {
  constructor(private iziToast: Ng2IzitoastService, private shared: SharedService) { }
  public success(msg: { title?: string, message?: string }): void {
    this.destroy();
    this.iziToast.show({
      message: this.shared.t(msg.title),
      messageColor: '#fff',
      ...
      position: this.shared.isRTL() ? 'bottomLeft' : 'bottomRight', // bottomRight, bottomLeft, topRight, topLeft, topCenter, bottomCenter, center
      target: '',
      targetFirst: true,
      timeout: 5000,
      drag: true,
  ...
  public error(msg: { title?: string, message?: string }): void {
    this.destroy();
    this.iziToast.show({
      title: this.shared.t(msg.title),
      titleColor: '#fff',
      message: this.shared.t(msg.message),
      messageColor: '#fff',
